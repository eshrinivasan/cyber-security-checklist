    ...
    function datafactory($rootScope, $http){
      var datafactory = { };
    	...
    	datafactory.questions = [
			   {id: 1, text: '1)	Does your firm store, use or transmit personally identifiable information (PII) or firm sensitive information electronically?', section:"1", answer:[1,2,4,6,8,9,10,11]},
